...
public class KPIBrowser {
    ...
    public static void main(String[] args) throws Exception {
        String input = "hdfs://192.168.1.201:9000/user/hdfs/log_kpi";
        String output = "hdfs://192.168.1.201:9000/user/hdfs/log_kpi/browser";
        ...
        conf.addResource("classpath:/hadoop/masters.xml");
        conf.addResource("classpath:/hadoop/slaves.xml");
